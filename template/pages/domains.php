<aside class="right-side">
	...
	<section class="content-header">
		<h1 class="pull-left"><?php _e('Domains'); ?><small> <?php _e('Manage domain expiry monitoring'); ?></small></h1>
		<div class="pull-right"><?php if(in_array("addDomain",$perms)) { ?><a onClick='showM("?modal=domains/add&reroute=domains");return false' data-toggle="modal" class="btn btn-flat btn-primary btn-sm"><?php _e('ADD DOMAIN'); ?></a><?php } ?></div>
	                        ...
	                        <table id="dataTableAjax" class="table table-striped table-hover table-bordered">
	                            <thead>
	                                <tr>
	                                    ...
	                                    <th><?php _e('Name'); ?></th>
										<th><?php _e('Group'); ?></th>
										<th class="nosort"><?php _e('Domain'); ?></th>
										<th class="nosort"><?php _e('Last Checked'); ?></th>
										<th class="nosort"><?php _e('Expiry Date'); ?></th>
