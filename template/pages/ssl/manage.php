            ...
            <div class='col-md-12'>
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li <?php if ($section == "" or $section == "overview") echo 'class="active"'; ?> ><a href="?route=ssl/manage&id=<?php echo $sslcert['id']; ?>&section=" ><?php _e('Overview'); ?></a></li>
                        <li <?php if ($section == "alerting") echo 'class="active"'; ?> ><a href="?route=ssl/manage&id=<?php echo $sslcert['id']; ?>&section=alerting"><?php _e('Alerting'); ?></a></li>
						<li <?php if ($section == "incidents") echo 'class="active"'; ?> ><a href="?route=ssl/manage&id=<?php echo $sslcert['id']; ?>&section=incidents"><?php _e('Incidents'); ?></a></li>

						<div class="btn-group pull-right" style="padding:6px;">
							<?php if ($section == "alerting") { ?>
								<a data-toggle='tooltip' title='Add Alert' class="btn btn-primary btn-flat btn-sm " href="#" onClick='showM("?modal=sslalerts/add&reroute=ssl/manage&routeid=<?php echo $sslcert['id']; ?>");return false'><i class="fa fa-plus"></i> ADD ALERT</a>
							<?php } ?>
						</div>
                        ...
                        <div class="tab-pane <?php if ($section == "") echo 'active'; ?>" id="overview">
							...
							<?php if(empty($history)) { ?>
								<div class="alert alert-warning" role="alert">
									...
									<?php _e('No data available yet. The next scheduled check will populate this SSL certificate\'s expiry information.'); ?>
								</div>
							<?php } else { ?>
	                            <div class='row'>
	                                ...
	                                <div class='col-md-4'>
																		...
																		<td>
																			...
																			<?php } elseif($incident['status'] == 2) { ?>
																				<?php if(in_array("editSsl",$perms)) { ?>
																					<a href="#" onClick='showM("?modal=sslalerts/markResolved&reroute=ssl/manage&routeid=<?php echo $sslcert['id']; ?>&id=<?php echo $incident['id']; ?>&section=");return false'><i class="fa fa-2x fa-warning text-yellow" data-toggle="tooltip" title="<?php _e("Warning"); ?>"></i></a>
																			...
																			<?php } elseif($incident['status'] == 3) { ?>
																				<?php if(in_array("editSsl",$perms)) { ?>
																					<a href="#" onClick='showM("?modal=sslalerts/markResolved&reroute=ssl/manage&routeid=<?php echo $sslcert['id']; ?>&id=<?php echo $incident['id']; ?>&section=");return false'><i class="fa fa-2x fa-warning text-red" data-toggle="tooltip" title="<?php _e("Alert"); ?>"></i></a>
	                                    ...
	                                    <div class="box box-primary">
	            							<div class="box-header">
	            								<h3 class="box-title"><?php _e('SSL Info'); ?></h3>
	            								<div class="pull-right box-tools">
	            									<button type="button" class="btn btn-default btn-sm" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
	            								</div>
	            							</div>
	            							...
	            							<div class="box-body">
	            								<table id="websiteInfoTable" class="table table-striped table-hover">
	            									<tbody>
	                                                    ...
	                                                    <tr>
	                                                        <td><b><?php _e('Issuer'); ?></b></td>
	                                                        <td><?php echo $latest['issuer']; ?></td>
	                                                    </tr>
											...
											<tr>
												...
												<td>
													<div class='pull-right'>
														<div class="btn-group">
															 <?php if(in_array("editSsl",$perms)) { ?><a href="#" onClick='showM("?modal=sslalerts/edit&reroute=ssl/manage&routeid=<?php echo $sslcert['id']; ?>&id=<?php echo $alert['id']; ?>&section=alerting");return false'  class="btn btn-success btn-flat btn-sm"><i class="fa fa-edit"></i></a><?php } ?>
															 <?php if(in_array("editSsl",$perms)) { ?><a href="#" onClick='showM("?modal=sslalerts/delete&reroute=ssl/manage&routeid=<?php echo $sslcert['id']; ?>&id=<?php echo $alert['id']; ?>&section=alerting");return false' class="btn btn-danger btn-flat btn-sm"><i class="fa fa-trash-o"></i></a><?php } ?>
														</div>
													</div>
												</td>
											</tr>
										...
										<?php foreach ($incidents as $incident) { ?>
											<tr>
												<td>
													...
													<?php } elseif($incident['status'] == 2) { ?>
														<?php if(in_array("editSsl",$perms)) { ?>
															<a href="#" onClick='showM("?modal=sslalerts/markResolved&reroute=ssl/manage&routeid=<?php echo $sslcert['id']; ?>&id=<?php echo $incident['id']; ?>&section=incidents");return false'><i class="fa fa-2x fa-warning text-yellow" data-toggle="tooltip" title="<?php _e("Warning"); ?>"></i></a>
														<?php } ?>
													<?php } elseif($incident['status'] == 3) { ?>
														<?php if(in_array("editSsl",$perms)) { ?>
															<a href="#" onClick='showM("?modal=sslalerts/markResolved&reroute=ssl/manage&routeid=<?php echo $sslcert['id']; ?>&id=<?php echo $incident['id']; ?>&section=incidents");return false'><i class="fa fa-2x fa-warning text-red" data-toggle="tooltip" title="<?php _e("Alert"); ?>"></i></a>
														<?php } ?>
													<?php } else { ?>
														<i class="fa fa-2x fa-warning text-gray" data-toggle="tooltip" title="<?php _e("Unknown"); ?>"></i>
													<?php } ?>
												...
												<td><?php echo dateTimeDisplay($incident['start_time']); ?></td>
												<td>
													<?php if($incident['end_time'] != "0000-00-00 00:00:00") echo dateTimeDisplay($incident['end_time']); else { ?> <a href="#" onClick='showM("?modal=sslalerts/markResolved&reroute=ssl/manage&routeid=<?php echo $sslcert['id']; ?>&id=<?php echo $incident['id']; ?>&section=incidents");return false'><?php _e("Mark Resolved"); ?></a>  <?php } ?>
												</td>

                                                <td>
													<?php  echo $incident['comment']; ?> <?php if($incident['ignore'] == '1') { ?> [<?php _e('IGNORED'); ?>]<?php } ?> <a href="#" onClick='showM("?modal=sslalerts/editComment&reroute=ssl/manage&routeid=<?php echo $sslcert['id']; ?>&id=<?php echo $incident['id']; ?>&section=incidents");return false'><?php if($incident['comment'] == "") _e("Add"); else _e("Edit"); ?></a>
