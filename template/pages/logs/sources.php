<aside class="right-side">
	...
	<section class="content-header">
		<h1 class="pull-left"><?php _e('Log Sources'); ?><small> <?php _e('Configure what gets collected and how, per server'); ?></small></h1>
		<div class="pull-right"><?php if(in_array("manageLogSources",$perms)) { ?><a onClick='showM("?modal=logsources/add&reroute=logs/sources");return false' data-toggle="modal" class="btn btn-flat btn-primary btn-sm"><?php _e('ADD LOG SOURCE'); ?></a><?php } ?></div>
                    ...
                    <div class="box-body">
						<div class="table-responsive">
	                        <table id="dataTableAjax" class="table table-striped table-hover table-bordered">
	                            <thead>
	                                <tr>
										<th style="width:1%"><?php _e('Mode'); ?></th>
	                                    <th style="width:1%"><?php _e('ID'); ?></th>
	                                    <th><?php _e('Server'); ?></th>
										<th><?php _e('Source'); ?></th>
										<th class="nosort"><?php _e('Rate'); ?></th>
