<aside class="right-side">
	...
	<section class="content-header">
		<h1 class="pull-left"><?php _e('Check Services'); ?><small> <?php _e('Manage check services'); ?></small></h1>
		<div class="pull-right"><?php if(in_array("addCheck",$perms)) { ?><a onClick='showM("?modal=checks/add&reroute=checks");return false' data-toggle="modal" class="btn btn-flat btn-primary btn-sm"><?php _e('ADD SERVICE'); ?></a><?php } ?></div>
