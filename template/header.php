                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown notifications-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <?php if(count($main_domains_unresolved) == 0) { ?><span class="label label-success"><i class="fa fa-check"></i></span><?php } ?>
                                <?php if(count($main_domains_unresolved) > 0) { ?><span class="label label-warning"><?php echo count($main_domains_unresolved); ?></span><?php } ?>
                            </a>
                            <ul class="dropdown-menu">
                                <li class="header">
                                    <?php if(count($main_domains_unresolved) == 0) { ?><?php _e('Hooray! All domains are healthy.') ?><?php } ?>
                                    <?php if(count($main_domains_unresolved) > 0) { ?><?php _e('You have') ?> <?php echo count($main_domains_unresolved); ?> <?php _e('domain alerts.') ?><?php } ?>
                                </li>

                                <li>
                                    <ul class="menu">
                                        <?php if(count($main_domains_unresolved) == 0) { ?>
                                            <li class="text-center"><i class="fa fa-check-circle fa-5x text-green" style="padding:50px;"></i></li>
                                        <?php } ?>

                                        <?php foreach($main_domains_unresolved as $incident) { ?>
                                            <li>
                                                <a href="?route=domains/manage&id=<?php echo $incident['domainid']; ?>">
                                                    <?php if($incident['status'] == 2) { ?>
                                                        <i class="fa fa-warning text-yellow" data-toggle="tooltip" title="<?php _e("Warning"); ?>"></i>
                                                    <?php } ?>
                        ...
                        <li class="dropdown notifications-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <?php if(count($main_ssl_unresolved) == 0) { ?><span class="label label-success"><i class="fa fa-check"></i></span><?php } ?>
                                <?php if(count($main_ssl_unresolved) > 0) { ?><span class="label label-warning"><?php echo count($main_ssl_unresolved); ?></span><?php } ?>
                            </a>
                            <ul class="dropdown-menu">
                                <li class="header">
                                    <?php if(count($main_ssl_unresolved) == 0) { ?><?php _e('Hooray! All SSL certificates are healthy.') ?><?php } ?>
                                    <?php if(count($main_ssl_unresolved) > 0) { ?><?php _e('You have') ?> <?php echo count($main_ssl_unresolved); ?> <?php _e('SSL alerts.') ?><?php } ?>
                                </li>

                                <li>
                                    <ul class="menu">
                                        <?php if(count($main_ssl_unresolved) == 0) { ?>
                                            <li class="text-center"><i class="fa fa-check-circle fa-5x text-green" style="padding:50px;"></i></li>
                                        <?php } ?>

                                        <?php foreach($main_ssl_unresolved as $incident) { ?>
                                            <li>
                                                <a href="?route=ssl/manage&id=<?php echo $incident['sslid']; ?>">
                                                    <?php if($incident['status'] == 2) { ?>
                                                        <i class="fa fa-warning text-yellow" data-toggle="tooltip" title="<?php _e("Warning"); ?>"></i>
                                                    <?php } ?>
                                ...
                                <li>
                                    <ul class="menu">
                                        ...
                                        <?php if(in_array("addCheck",$perms)) { ?>
                                            <li><a href="#" onClick='showM("?modal=checks/add&reroute=servers&routeid=&section=");return false' data-toggle="modal"><i class="fa fa-check-circle text-blue"></i> <?php _e('Add Service'); ?></a></li>
                                            <li><a href="#" onClick='showM("?modal=domains/add&reroute=servers&routeid=&section=");return false' data-toggle="modal"><i class="fa fa-id-card text-blue"></i> <?php _e('Add Domain'); ?></a></li>
                                            <li><a href="#" onClick='showM("?modal=ssl/add&reroute=servers&routeid=&section=");return false' data-toggle="modal"><i class="fa fa-lock text-blue"></i> <?php _e('Add SSL Check'); ?></a></li>
                                        <?php } ?>
          ...
          <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <li <?php if(strpos($route,'checks') !== false) echo 'class="active"'; ?>>
                  <a href="?route=checks">
                      <i class="fa fa-check-circle fa-fw"></i> <span><?php _e('Check Services'); ?></span>
                  </a>
              </li>
              <?php } ?>

              <?php if(in_array("viewDomains",$perms)) { ?>
              <li <?php if(strpos($route,'domains') !== false) echo 'class="active"'; ?>>
                  <a href="?route=domains">
                      <i class="fa fa-id-card fa-fw"></i> <span><?php _e('Domains'); ?></span>
                  </a>
              </li>
              <?php } ?>

              <?php if(in_array("viewSsl",$perms)) { ?>
              <li <?php if(strpos($route,'ssl') !== false) echo 'class="active"'; ?>>
                  <a href="?route=ssl">
                      <i class="fa fa-lock fa-fw"></i> <span><?php _e('SSL Certificates'); ?></span>
                  </a>
              </li>
              <?php } ?>
