...
<div class="modal-body">
    <h4><?php echo e($template['name']); ?></h4><br>
    <div class="form-group">
        <label for="subject"><?php _e('Subject'); ?> *</label>
        <input type="text" class="form-control" id="subject" name="subject" value="<?php echo e($template['subject']); ?>" required>
    </div>

    <div class="form-group">
        <label for="message" class="control-label"><?php _e('Message'); ?></label>
        <textarea class="form-control summernote2" id="message" name="message"><?php echo e($template['message']); ?></textarea>
    </div>

    <p><?php echo e($template['info']); ?></p>
