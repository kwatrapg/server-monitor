    ...
    <div class="row">
        <div class="col-md-8">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="name" name="name" value="<?php echo $sslcert['name']; ?>" required placeholder="<?php _e('Name for easy identification'); ?>">
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 select2-hidden-accessible" id="groupid" name="groupid" style="width: 100%;" tabindex="-1" aria-hidden="true" required>
                    <?php foreach ($groups as $group) { if(!checkGroup($group['id'])) continue; ?>
                        <option value='<?php echo $group['id']; ?>' <?php if($group['id'] == $sslcert['groupid']) echo "selected"; ?>><?php echo $group['name']; ?></option>
                    <?php } ?>
                </select>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="url" name="url" value="<?php echo $sslcert['url']; ?>" required placeholder="<?php _e('https://www.mydomain.com'); ?>" data-validation="url" data-validation-error-msg="<?php _e('Incorrect URL! (eg. https://www.google.com)'); ?>">
            </div>
        </div>
