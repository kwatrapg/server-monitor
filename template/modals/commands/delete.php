<div class="modal-header">
    ...
    <h4 class="modal-title"><?php _e('Delete Command'); ?></h4>
</div>

<div class="modal-body">
    <?php _e('Are you sure you want to delete this command? The agent will stop running it on the next collection cycle.'); ?>
