...
<div class="modal-body">
    ...
    <div class="form-group">
        <div class="checkbox"><label><input type="checkbox" name="ignore" <?php if($incident['ignore'] == "1") echo 'checked="yes"'; ?> value="1"> <?php _e('Ignore'); ?></label></div>
    </div>

    <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>">
    <input type="hidden" name="action" value="editDomainIncidentComment">
