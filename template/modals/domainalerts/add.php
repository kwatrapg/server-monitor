<div class="modal-header">
    ...
    <h4 class="modal-title"><?php _e('Add Domain Alert'); ?></h4>
</div>
...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select class="form-control select2 select2-hidden-accessible" id="type" name="type" style="width: 100%;" tabindex="-1" aria-hidden="true" required>
                        <option></option>
                        <option value='expiringsoon'><?php _e('Expiring Soon (days remaining)'); ?></option>
                        <option value='expired'><?php _e('Already Expired (days remaining)'); ?></option>
                </select>
            </div>
        </div>
        ...
        <div class="col-md-2">
            <div class="form-group" id="comparison_limit-div">
                ...
                <input type="text" class="form-control" id="comparison_limit" name="comparison_limit" value="30">
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="occurrences" name="occurrences" required value="1">
            </div>
        </div>
    ...
    <input type="hidden" name="domainid" value="<?php echo e($_GET['routeid'] ?? ''); ?>">

    <input type="hidden" name="action" value="addDomainAlert">
