...
<div class="modal-body">
    ...
    <div class="form-group" id="comment-div">
        ...
        <input type="text" class="form-control" id="comment" name="comment" value="<?php echo $logincident['comment'] ?>">
    </div>

    <input type="hidden" name="ignore" value="0">
    <div class="form-group">
        <div class="checkbox"><label><input type="checkbox" name="ignore" <?php if($logincident['ignore'] == "1") echo 'checked="yes"'; ?> value="1"> <?php _e('Ignore'); ?></label></div>
    </div>

    <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>">
    <input type="hidden" name="action" value="editLogIncidentComment">
